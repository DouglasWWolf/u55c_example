...
HD_PWD='/home/wolf/fpga/u55c_pcie_template/project.runs/top_level_xdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_xdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_xdma_0_0.tcl
